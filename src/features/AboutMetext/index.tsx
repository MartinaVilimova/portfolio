...
const AboutMeText: React.FC = () => (
		<Wrapper>
			<StyledH3>
				<SmallText>Junior</SmallText>{' '}
				<ColorfulText>Front-end</ColorfulText>
			</StyledH3>
			<ContentColumns
				columns={NumberColumns.Columns2}
				columnsIpad={NumberColumnsIpad.Columns2}
			>
				<PersonalInfo1>
					<Name>
			...
			<Paragraph>
				...
				deleniti, doloremque excepturi voluptatem. Lorem, ipsum dolor
				sit amet consectetur adipisicing elit. Corrupti doloremque enim
				reprehenderit minus similique illum mollitia ea architecto
				placeat maiores, asperiores est harum atque animi omnis ipsum
				quos obcaecati incidunt.
			</Paragraph>
			<WrapperLinks>
				<StyledLink to="/">
